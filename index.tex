...
\begin{document}
\maketitle
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[interior hidden, boxrule=0pt, frame hidden, sharp corners, enhanced, borderline west={3pt}{0pt}{shadecolor}, breakable]}{\end{tcolorbox}}\fi
...
although \texttt{ggplot2} gives a warning message for using it inside
the \texttt{axis.text.x} argument. But, for now, at least, it works
fine.

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{ggplot}\NormalTok{(rr,}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{Name, }\AttributeTok{y=}\NormalTok{PctChange)) }\SpecialCharTok{+}
  \FunctionTok{geom\_segment}\NormalTok{(}
    \FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{Name, }
        ...
        \AttributeTok{color=}\FunctionTok{ifelse}\NormalTok{(rr}\SpecialCharTok{$}\NormalTok{PctChange }\SpecialCharTok{\textless{}} \SpecialCharTok{{-}}\DecValTok{25}\NormalTok{, }\StringTok{"darkorange"}\NormalTok{, }\StringTok{"grey44"}\NormalTok{), }
        \AttributeTok{linewidth=}\FunctionTok{ifelse}\NormalTok{(rr}\SpecialCharTok{$}\NormalTok{PctChange }\SpecialCharTok{\textless{}} \SpecialCharTok{{-}}\DecValTok{25}\NormalTok{, }\FloatTok{1.1}\NormalTok{, }\FloatTok{0.7}\NormalTok{)}
\NormalTok{    )}\SpecialCharTok{+}
  \FunctionTok{geom\_point}\NormalTok{(}
         \AttributeTok{color=}\FunctionTok{ifelse}\NormalTok{(rr}\SpecialCharTok{$}\NormalTok{PctChange }\SpecialCharTok{\textless{}} \SpecialCharTok{{-}}\DecValTok{25}\NormalTok{, }\StringTok{"darkorange"}\NormalTok{, }\StringTok{"grey44"}\NormalTok{), }
         \AttributeTok{size=}\FunctionTok{ifelse}\NormalTok{(rr}\SpecialCharTok{$}\NormalTok{PctChange }\SpecialCharTok{\textless{}} \SpecialCharTok{{-}}\DecValTok{25}\NormalTok{, }\DecValTok{3}\NormalTok{, }\DecValTok{1}\NormalTok{)) }\SpecialCharTok{+}
  \FunctionTok{xlab}\NormalTok{(}\StringTok{"Station"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{ylab}\NormalTok{(}\StringTok{"Percent Change from Previous Year \%"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{theme\_light}\NormalTok{() }\SpecialCharTok{+}
  \FunctionTok{theme}\NormalTok{(}\AttributeTok{legend.position=}\StringTok{\textquotesingle{}none\textquotesingle{}}\NormalTok{,}
        ...
        \AttributeTok{axis.text.x =} \FunctionTok{element\_text}\NormalTok{(}\AttributeTok{angle =} \DecValTok{90}\NormalTok{, }\AttributeTok{vjust =} \FloatTok{0.5}\NormalTok{, }\AttributeTok{hjust=}\DecValTok{1}\NormalTok{,}
                     \AttributeTok{face=}\FunctionTok{ifelse}\NormalTok{(rr}\SpecialCharTok{$}\NormalTok{PctChange }\SpecialCharTok{\textless{}} \SpecialCharTok{{-}}\DecValTok{25}\NormalTok{,}\StringTok{"bold"}\NormalTok{,}\StringTok{"plain"}\NormalTok{),}
                     \AttributeTok{size=}\FunctionTok{ifelse}\NormalTok{(rr}\SpecialCharTok{$}\NormalTok{PctChange }\SpecialCharTok{\textless{}} \SpecialCharTok{{-}}\DecValTok{25}\NormalTok{,}\DecValTok{7}\NormalTok{,}\DecValTok{5}\NormalTok{),}
                     \AttributeTok{color=}\FunctionTok{ifelse}\NormalTok{(rr}\SpecialCharTok{$}\NormalTok{PctChange }\SpecialCharTok{\textless{}} \SpecialCharTok{{-}}\DecValTok{25}\NormalTok{,}\StringTok{"\#A14A11"}\NormalTok{,}\StringTok{"grey44"}\NormalTok{))}
\NormalTok{        ) }
\end{Highlighting}
\end{Shaded}

\includegraphics{./img/dot.png}
