...
{\centering \includegraphics{./rainclouds_files/figure-pdf/unnamed-chunk-2-1.pdf}
...
{\centering \includegraphics{./rainclouds_files/figure-pdf/unnamed-chunk-4-1.pdf}
...
{\centering \includegraphics{./rainclouds_files/figure-pdf/unnamed-chunk-5-1.pdf}
...
{\centering \includegraphics{./rainclouds_files/figure-pdf/unnamed-chunk-6-1.pdf}
...
{\centering \includegraphics{./rainclouds_files/figure-pdf/unnamed-chunk-8-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{rail }\OtherTok{\textless{}{-}} \FunctionTok{read.csv}\NormalTok{(}\StringTok{"data\_raw/station\_usage.csv"}\NormalTok{)}

\NormalTok{df }\OtherTok{\textless{}{-}}\NormalTok{ rail[}\FunctionTok{c}\NormalTok{(}\DecValTok{2}\SpecialCharTok{:}\DecValTok{4}\NormalTok{,}\DecValTok{15}\NormalTok{,}\DecValTok{20}\NormalTok{)]}
\FunctionTok{colnames}\NormalTok{(df) }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\StringTok{"TLC"}\NormalTok{,}\StringTok{"Name"}\NormalTok{,}\StringTok{"Region"}\NormalTok{,}\StringTok{"Network"}\NormalTok{,}\StringTok{"Passengers"}\NormalTok{)}
\NormalTok{df}\SpecialCharTok{$}\NormalTok{Passengers }\OtherTok{\textless{}{-}} \FunctionTok{as.numeric}\NormalTok{(}\FunctionTok{gsub}\NormalTok{(}\StringTok{","}\NormalTok{,}\StringTok{""}\NormalTok{,df}\SpecialCharTok{$}\NormalTok{Passengers))}
\FunctionTok{head}\NormalTok{(df)}
\end{Highlighting}
\end{Shaded}
...
{\centering \includegraphics{./lollipop_files/figure-pdf/unnamed-chunk-3-1.pdf}
...
{\centering \includegraphics{./lollipop_files/figure-pdf/unnamed-chunk-4-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{top10}\SpecialCharTok{$}\NormalTok{TLC }\OtherTok{\textless{}{-}} \FunctionTok{factor}\NormalTok{(top10}\SpecialCharTok{$}\NormalTok{TLC, }\AttributeTok{levels =}\NormalTok{ top10 }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{pull}\NormalTok{(TLC))}
...
\FunctionTok{ggplot}\NormalTok{(top10, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{TLC, }\AttributeTok{y=}\NormalTok{Passengers, }\AttributeTok{color=}\NormalTok{TLC, }\AttributeTok{fill=}\NormalTok{TLC)) }\SpecialCharTok{+}
  ...
  \FunctionTok{scale\_fill\_manual}\NormalTok{(}\AttributeTok{values =} \FunctionTok{rev}\NormalTok{(pals}\SpecialCharTok{::}\FunctionTok{brewer.reds}\NormalTok{(}\DecValTok{10}\NormalTok{))) }
\end{Highlighting}
\end{Shaded}

\begin{figure}[H]

{\centering \includegraphics{./lollipop_files/figure-pdf/unnamed-chunk-5-1.pdf}

}

\end{figure}

Below I add some extra customization. We set the theme to be
\texttt{theme\_light}, remove the legend which is superfluous and tidy
up the panel border and x-axis ticks. I also change the y-axis scale to
show numbers in millions with the letter ``M''. This is using the
\texttt{scales::label\_number} function (from the \texttt{scales}
package).
...
{\centering \includegraphics{./lollipop_files/figure-pdf/unnamed-chunk-6-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{rr }\OtherTok{\textless{}{-}}\NormalTok{ rail[rail}\SpecialCharTok{$}\NormalTok{Region}\SpecialCharTok{==}\StringTok{"East Midlands"}\NormalTok{,]}
\NormalTok{rr }\OtherTok{\textless{}{-}}\NormalTok{ rr[}\FunctionTok{c}\NormalTok{(}\DecValTok{2}\SpecialCharTok{:}\DecValTok{4}\NormalTok{,}\DecValTok{15}\NormalTok{,}\DecValTok{20}\NormalTok{,}\DecValTok{27}\NormalTok{)]}
\FunctionTok{colnames}\NormalTok{(rr) }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\StringTok{"TLC"}\NormalTok{,}\StringTok{"Name"}\NormalTok{,}\StringTok{"Region"}\NormalTok{,}\StringTok{"Network"}\NormalTok{,}\StringTok{"Passengers"}\NormalTok{,}\StringTok{"PctChange"}\NormalTok{)}
\NormalTok{rr}\SpecialCharTok{$}\NormalTok{Passengers }\OtherTok{\textless{}{-}} \FunctionTok{as.numeric}\NormalTok{(}\FunctionTok{gsub}\NormalTok{(}\StringTok{","}\NormalTok{,}\StringTok{""}\NormalTok{,rr}\SpecialCharTok{$}\NormalTok{Passengers))}
\NormalTok{rr}\SpecialCharTok{$}\NormalTok{PctChange }\OtherTok{\textless{}{-}} \FunctionTok{as.numeric}\NormalTok{(}\FunctionTok{gsub}\NormalTok{(}\StringTok{"\%"}\NormalTok{,}\StringTok{""}\NormalTok{,rr}\SpecialCharTok{$}\NormalTok{PctChange))}
\FunctionTok{head}\NormalTok{(rr)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{rr}\SpecialCharTok{$}\NormalTok{UpDown }\OtherTok{\textless{}{-}} \FunctionTok{ifelse}\NormalTok{(rr}\SpecialCharTok{$}\NormalTok{PctChange }\SpecialCharTok{\textgreater{}} \DecValTok{0}\NormalTok{, }\StringTok{"up"}\NormalTok{,}\StringTok{"down"}\NormalTok{)}

\NormalTok{rr }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{arrange}\NormalTok{(}\SpecialCharTok{{-}}\NormalTok{Passengers) }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{pull}\NormalTok{(TLC)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{rr}\SpecialCharTok{$}\NormalTok{TLC }\OtherTok{\textless{}{-}} \FunctionTok{factor}\NormalTok{(rr}\SpecialCharTok{$}\NormalTok{TLC, }\AttributeTok{levels =}\NormalTok{ rr }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{arrange}\NormalTok{(}\SpecialCharTok{{-}}\NormalTok{Passengers) }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{pull}\NormalTok{(TLC))}
\NormalTok{rr}\SpecialCharTok{$}\NormalTok{Name }\OtherTok{\textless{}{-}} \FunctionTok{factor}\NormalTok{(rr}\SpecialCharTok{$}\NormalTok{Name, }\AttributeTok{levels =}\NormalTok{ rr }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{arrange}\NormalTok{(}\SpecialCharTok{{-}}\NormalTok{Passengers) }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{pull}\NormalTok{(Name))}
\end{Highlighting}
\end{Shaded}
...
{\centering \includegraphics{./lollipop_files/figure-pdf/unnamed-chunk-9-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{rrr }\OtherTok{\textless{}{-}}\NormalTok{ rr }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{filter}\NormalTok{(Passengers}\SpecialCharTok{\textgreater{}}\DecValTok{250000}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{arrange}\NormalTok{(}\SpecialCharTok{{-}}\NormalTok{Passengers)}

\NormalTok{ c1 }\OtherTok{\textless{}{-}} \FunctionTok{ifelse}\NormalTok{(rrr}\SpecialCharTok{$}\NormalTok{PctChange }\SpecialCharTok{\textgreater{}} \DecValTok{10}\NormalTok{,}\StringTok{"bold"}\NormalTok{,}\StringTok{"plain"}\NormalTok{)}
\NormalTok{ c2 }\OtherTok{\textless{}{-}} \FunctionTok{ifelse}\NormalTok{(rrr}\SpecialCharTok{$}\NormalTok{PctChange }\SpecialCharTok{\textgreater{}} \DecValTok{10}\NormalTok{,}\DecValTok{12}\NormalTok{,}\DecValTok{9}\NormalTok{)}
\NormalTok{ c3 }\OtherTok{\textless{}{-}} \FunctionTok{ifelse}\NormalTok{(rrr}\SpecialCharTok{$}\NormalTok{PctChange }\SpecialCharTok{\textgreater{}} \DecValTok{10}\NormalTok{,}\StringTok{"\#A14A11"}\NormalTok{,}\StringTok{"grey44"}\NormalTok{)}

\FunctionTok{ggplot}\NormalTok{(rrr,}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{Name, }\AttributeTok{y=}\NormalTok{PctChange)) }\SpecialCharTok{+}
  \FunctionTok{geom\_segment}\NormalTok{(}
    \FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{Name, }
        \AttributeTok{xend=}\NormalTok{Name, }
        \AttributeTok{y=}\DecValTok{0}\NormalTok{, }
        \AttributeTok{yend=}\NormalTok{PctChange),}
        \AttributeTok{color=}\FunctionTok{ifelse}\NormalTok{(rrr}\SpecialCharTok{$}\NormalTok{PctChange }\SpecialCharTok{\textgreater{}} \DecValTok{10}\NormalTok{, }\StringTok{"darkorange"}\NormalTok{, }\StringTok{"grey44"}\NormalTok{), }
        \AttributeTok{linewidth=}\FunctionTok{ifelse}\NormalTok{(rrr}\SpecialCharTok{$}\NormalTok{PctChange }\SpecialCharTok{\textgreater{}} \DecValTok{10}\NormalTok{, }\FloatTok{1.5}\NormalTok{, }\FloatTok{1.1}\NormalTok{)}
\NormalTok{    )}\SpecialCharTok{+}
  \FunctionTok{geom\_point}\NormalTok{(}
         \AttributeTok{color=}\FunctionTok{ifelse}\NormalTok{(rrr}\SpecialCharTok{$}\NormalTok{PctChange }\SpecialCharTok{\textgreater{}} \DecValTok{10}\NormalTok{, }\StringTok{"darkorange"}\NormalTok{, }\StringTok{"grey44"}\NormalTok{), }
         \AttributeTok{size=}\FunctionTok{ifelse}\NormalTok{(rrr}\SpecialCharTok{$}\NormalTok{PctChange }\SpecialCharTok{\textgreater{}} \DecValTok{10}\NormalTok{, }\DecValTok{5}\NormalTok{, }\DecValTok{2}\NormalTok{)) }\SpecialCharTok{+}
  \FunctionTok{xlab}\NormalTok{(}\StringTok{"Station"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{ylab}\NormalTok{(}\StringTok{"Percent Change from Previous Year \%"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{geom\_hline}\NormalTok{(}\AttributeTok{yintercept=}\DecValTok{0}\NormalTok{, }\AttributeTok{color=}\StringTok{\textquotesingle{}gray33\textquotesingle{}}\NormalTok{)}\SpecialCharTok{+}
  \FunctionTok{theme\_light}\NormalTok{() }\SpecialCharTok{+}
  \FunctionTok{theme}\NormalTok{(}\AttributeTok{legend.position=}\StringTok{\textquotesingle{}none\textquotesingle{}}\NormalTok{,}
        \AttributeTok{axis.ticks.x =} \FunctionTok{element\_blank}\NormalTok{(),}
        \AttributeTok{panel.border =} \FunctionTok{element\_blank}\NormalTok{(),}
        ...
        \AttributeTok{axis.text.x =} \FunctionTok{element\_text}\NormalTok{(}\AttributeTok{angle =} \DecValTok{90}\NormalTok{, }\AttributeTok{vjust =} \FloatTok{0.5}\NormalTok{, }\AttributeTok{hjust=}\DecValTok{1}\NormalTok{,}
                                   \AttributeTok{face=}\NormalTok{c1,}\AttributeTok{size=}\NormalTok{c2,}\AttributeTok{color=}\NormalTok{c3)}
\NormalTok{        ) }
\end{Highlighting}
\end{Shaded}
...
{\centering \includegraphics{./lollipop_files/figure-pdf/unnamed-chunk-10-1.pdf}
...
{\centering \includegraphics{./labelsig_files/figure-pdf/unnamed-chunk-4-1.pdf}
...
{\centering \includegraphics{./labelsig_files/figure-pdf/unnamed-chunk-5-1.pdf}
...
{\centering \includegraphics{./labelsig_files/figure-pdf/unnamed-chunk-11-1.pdf}
...
{\centering \includegraphics{./labelsig_files/figure-pdf/unnamed-chunk-12-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{t.test}\NormalTok{(pdf}\SpecialCharTok{$}\NormalTok{before, pdf}\SpecialCharTok{$}\NormalTok{after, }\AttributeTok{paired=}\NormalTok{T)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{pdf.long }\OtherTok{\textless{}{-}}\NormalTok{ pdf }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{pivot\_longer}\NormalTok{(}\AttributeTok{cols=}\DecValTok{2}\SpecialCharTok{:}\DecValTok{3}\NormalTok{, }\AttributeTok{names\_to =} \StringTok{"time"}\NormalTok{)}
\NormalTok{pdf.long}\SpecialCharTok{$}\NormalTok{time }\OtherTok{\textless{}{-}} \FunctionTok{factor}\NormalTok{(pdf.long}\SpecialCharTok{$}\NormalTok{time, }\AttributeTok{levels=}\FunctionTok{c}\NormalTok{(}\StringTok{"before"}\NormalTok{,}\StringTok{"after"}\NormalTok{))}
\NormalTok{pdf.long}
\end{Highlighting}
\end{Shaded}
...
{\centering \includegraphics{./labelsig_files/figure-pdf/unnamed-chunk-16-1.pdf}
...
{\centering \includegraphics{./labelsig_files/figure-pdf/unnamed-chunk-17-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{t.test}\NormalTok{(pdf}\SpecialCharTok{$}\NormalTok{before, pdf}\SpecialCharTok{$}\NormalTok{after, }\AttributeTok{paired=}\NormalTok{T, }\AttributeTok{alternative =} \StringTok{"less"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
{\centering \includegraphics{./labelsig_files/figure-pdf/unnamed-chunk-19-1.pdf}
...
{\centering \includegraphics{./labelsig_files/figure-pdf/unnamed-chunk-20-1.pdf}
...
{\centering \includegraphics{./labelsig_files/figure-pdf/unnamed-chunk-23-1.pdf}
...
{\centering \includegraphics{./labelsig_files/figure-pdf/unnamed-chunk-24-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{pvals }\OtherTok{\textless{}{-}} \FunctionTok{round}\NormalTok{(}\FunctionTok{TukeyHSD}\NormalTok{(fit)}\SpecialCharTok{$}\NormalTok{grp[,}\DecValTok{4}\NormalTok{],}\DecValTok{2}\NormalTok{)}
\NormalTok{pvals}
\end{Highlighting}
\end{Shaded}
...
{\centering \includegraphics{./labelsig_files/figure-pdf/unnamed-chunk-26-1.pdf}
...
{\centering \includegraphics{./labelsig_files/figure-pdf/unnamed-chunk-27-1.pdf}
...
{\centering \includegraphics{./labelsig_files/figure-pdf/unnamed-chunk-28-1.pdf}
...
{\centering \includegraphics{./labelsig_files/figure-pdf/unnamed-chunk-30-1.pdf}
...
{\centering \includegraphics{./labelsig_files/figure-pdf/unnamed-chunk-31-1.pdf}
...
{\centering \includegraphics{./labelsig_files/figure-pdf/unnamed-chunk-32-1.pdf}
...
{\centering \includegraphics{./labelsig_files/figure-pdf/unnamed-chunk-34-1.pdf}
...
{\centering \includegraphics{./labelsig_files/figure-pdf/unnamed-chunk-35-1.pdf}
...
\begin{Highlighting}[]
\NormalTok{df.sum }\OtherTok{\textless{}{-}}\NormalTok{ df }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{group\_by}\NormalTok{(group, condition) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{summarise}\NormalTok{(}
    \AttributeTok{sd =} \FunctionTok{sd}\NormalTok{(values),}
    \AttributeTok{mean =} \FunctionTok{mean}\NormalTok{(values)}
\NormalTok{  )}
\NormalTok{df.sum}\SpecialCharTok{$}\NormalTok{condition }\OtherTok{\textless{}{-}} \FunctionTok{factor}\NormalTok{(df.sum}\SpecialCharTok{$}\NormalTok{condition, }\AttributeTok{levels=}\FunctionTok{c}\NormalTok{(}\StringTok{"low"}\NormalTok{,}\StringTok{"medium"}\NormalTok{,}\StringTok{"high"}\NormalTok{))}
...
{\centering \includegraphics{./labelsig_files/figure-pdf/unnamed-chunk-38-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{dfa }\OtherTok{\textless{}{-}}\NormalTok{ df }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{filter}\NormalTok{(group}\SpecialCharTok{==}\StringTok{"A"}\NormalTok{)}
\NormalTok{dfa}\SpecialCharTok{$}\NormalTok{condition }\OtherTok{\textless{}{-}} \FunctionTok{factor}\NormalTok{(dfa}\SpecialCharTok{$}\NormalTok{condition, }\AttributeTok{levels =} \FunctionTok{c}\NormalTok{(}\StringTok{"low"}\NormalTok{,}\StringTok{"medium"}\NormalTok{,}\StringTok{"high"}\NormalTok{))}
...
{\centering \includegraphics{./labelsig_files/figure-pdf/unnamed-chunk-39-1.pdf}
...
{\centering \includegraphics{./labelsig_files/figure-pdf/unnamed-chunk-41-1.pdf}
...
{\centering \includegraphics{./labelsig_files/figure-pdf/unnamed-chunk-42-1.pdf}
...
{\centering \includegraphics{./labelsig_files/figure-pdf/unnamed-chunk-44-1.pdf}
...
{\centering \includegraphics{./labelsig_files/figure-pdf/unnamed-chunk-45-1.pdf}
...
{\centering \includegraphics{./labelsig_files/figure-pdf/unnamed-chunk-47-1.pdf}
...
{\centering \includegraphics{./labelsig_files/figure-pdf/unnamed-chunk-50-1.pdf}
...
{\centering \includegraphics{./labelsig_files/figure-pdf/unnamed-chunk-51-1.pdf}
...
{\centering \includegraphics{./labelsig_files/figure-pdf/unnamed-chunk-52-1.pdf}
...
{\centering \includegraphics{./labelsig_files/figure-pdf/unnamed-chunk-53-1.pdf}
...
{\centering \includegraphics{./labelsig_files/figure-pdf/unnamed-chunk-54-1.pdf}
